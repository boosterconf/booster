...
module Dates
	CFP_LIGHTNING_BEGINS = Date.parse("2018-09-01")
	CFP_LIGHTNING_ENDS = Date.parse("2018-11-21")
	CFP_TUTORIALS_BEGINS = Date.parse("2018-09-01")
	CFP_TUTORIAL_ENDS = Date.parse("2018-11-21")
